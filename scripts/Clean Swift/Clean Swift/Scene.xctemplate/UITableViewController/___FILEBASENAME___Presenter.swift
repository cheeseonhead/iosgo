...
{
    func presentSomething(response: ___FILEBASENAMEASIDENTIFIER___.___VARIABLE_usecase___.Response)
}

protocol ___FILEBASENAMEASIDENTIFIER___PresenterOutput: class
{
    func displaySomething(viewModel: ___FILEBASENAMEASIDENTIFIER___.___VARIABLE_usecase___.ViewModel)
}
